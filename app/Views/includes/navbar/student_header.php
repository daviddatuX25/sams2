<div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item <?= ($activeLink == 'classes') ? 'active' : '' ?>">
            <a class="nav-link " href="<?=BASE_URL?>/student/classes">
                <i class="fas fa-fw fa-door-open"></i>
                <span>Live Class</span>
            </a>
        </li>
        <li class="nav-item <?= ($activeLink == 'timeline') ? 'active' : '' ?>">
            <a class="nav-link " href="<?=BASE_URL?>/student/timeline">
    ...
    <!-- Main Wrapper (w/ head navigation) -->
    <div class="w-100">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" id="logout-user" href="#">
